        ...
        <section className="border-b border-border bg-muted/40">
          <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
            <span className="inline-flex items-center gap-1.5 rounded-md bg-teal/10 px-2.5 py-1 text-xs font-semibold text-teal">
              ...
              {t("liveClassesIndex.badge")}
            </span>
            <h1 className="mt-3 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">{t("liveClassesIndex.title")}</h1>
            <p className="mt-2 max-w-2xl text-muted-foreground">
              {t("liveClassesIndex.subtitle")}
            </p>
          </div>
        </section>
        <LiveClassesBrowser />
