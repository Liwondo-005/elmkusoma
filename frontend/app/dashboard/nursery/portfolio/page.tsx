    ...
    <div className="mx-auto max-w-4xl space-y-6 p-4 pb-24">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Your best work and achievements</p>
        </div>
      </div>
      ...
      <div className="nursery-card rounded-2xl bg-gradient-to-r from-purple-500 to-pink-400 p-5 text-white">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold">{user?.name || "My Portfolio"}</h2>
            <p className="text-sm text-white/70">{milestones.length} achievement{milestones.length !== 1 ? "s" : ""}</p>
          </div>
        </div>
      </div>
      ...
      {milestones.length > 0 ? (
        <section>
          <h2 className="mb-3 text-lg font-bold text-gray-800">My Achievements</h2>
        ...
        <div className="nursery-card rounded-2xl bg-white p-8 text-center">
          ...
          <h3 className="mt-3 text-lg font-bold text-gray-800">Portfolio is empty</h3>
          <p className="mt-1 text-sm text-gray-500">As you complete activities, your portfolio will grow!</p>
        </div>
      )}
    </div>
  )
