  ...
  return (
    <div className="mx-auto max-w-4xl space-y-4 p-4 pb-24">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-800">Create Studio</h1>
          <p className="text-sm text-gray-500">Draw pictures and make music!</p>
        </div>
      </div>
      ...
      {activeTab === "draw" ? (
        <div className="space-y-4">
          ...
          {/* Stamps */}
          <div>
            <p className="mb-2 text-xs font-bold text-gray-500">Stamps:</p>
            <div className="flex flex-wrap gap-2">
              {STAMPS.map((stamp) => (
                <button
                  key={stamp}
          ...
          <p className="text-center text-[10px] text-gray-400">Double-click canvas to clear</p>
        </div>
      ) : (
        <div className="space-y-4">
          <p className="text-center text-sm font-bold text-gray-600">Tap the keys to make music!</p>
