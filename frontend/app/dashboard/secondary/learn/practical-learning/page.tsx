  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 p-4 pb-24">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Practical Learning</h1>
          <p className="text-sm text-gray-500">Hands-on experiments and lab work</p>
        </div>
      </div>
      ...
      {selectedExperiment && activeExperiment ? (
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-6">
            ...
            <div className="mt-4">
              <h3 className="text-sm font-semibold text-gray-900">Materials Needed</h3>
            ...
            <div className="mt-4">
              <h3 className="text-sm font-semibold text-gray-900">Procedure</h3>
            ...
            <div className="mt-6 rounded-xl bg-amber-50 p-4">
              <p className="text-sm font-medium text-amber-800">
                Safety Note: Always follow laboratory safety guidelines. Wear protective equipment and perform experiments under teacher supervision.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="rounded-2xl border border-gray-100 bg-white p-6 text-center">
            ...
            <h2 className="mt-3 text-lg font-bold text-gray-800">Lab Experiments</h2>
            <p className="mt-1 text-sm text-gray-500">Choose an experiment to begin hands-on learning</p>
          </div>
          {experiments.map(exp => (
            <button
              key={exp.id}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400">{exp.subject} · {exp.materials.length} materials</p>
              </div>
