  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 p-4 pb-24">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Critical Thinking</h1>
          <p className="text-sm text-gray-500">Analyze arguments, evaluate evidence, solve problems</p>
        </div>
      </div>
      ...
      {score.answered > 0 && (
        <div className="flex gap-3">
          ...
          <div className="flex-1 rounded-xl bg-amber-50 p-3 text-center">
            ...
            <p className="text-[10px] font-medium text-amber-700">Incorrect</p>
          </div>
          <div className="flex-1 rounded-xl bg-indigo-50 p-3 text-center">
            ...
            <p className="text-[10px] font-medium text-indigo-700">Completed</p>
          </div>
        </div>
      )}
      ...
      {selectedChallenge && activeChallenge ? (
        <div className="space-y-4">
          <button onClick={() => setSelectedChallenge(null)} className="text-sm font-semibold text-indigo-600 hover:text-indigo-700">
            Back to challenges
          </button>
          ...
          {challenges.map(challenge => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400">{challenge.difficulty} · 4 options</p>
              </div>
