...
const universityNavSections: NavSection[] = [
  ...
  {
    label: "Deep Learning",
    href: "/dashboard/learner/deep-learning",
    icon: Brain,
    dotColor: "bg-purple-500",
  },
  {
    label: "Course Workspace",
    href: "/dashboard/learner/course-workspace",
    icon: BookOpen,
    dotColor: "bg-violet-500",
  },
  {
    label: "My Learning Kit",
    href: "/dashboard/learner/my-learning-kit",
    icon: Library,
    dotColor: "bg-amber-500",
  },
  {
    label: "Academic Assistant",
    href: "/dashboard/learner/academic-assistant",
    icon: Brain,
    dotColor: "bg-violet-500",
  },
]
