...
const universityNav: Array<{ label: string; href: string; icon: typeof LayoutDashboard }> = [
  { label: "Dashboard", href: "/dashboard", icon: LayoutDashboard },
  { label: "My Courses", href: "/dashboard/courses", icon: BookOpen },
  { label: "Live Campus", href: "/dashboard/live-classes", icon: Video },
  { label: "Assignments", href: "/dashboard/assignments", icon: FileText },
  { label: "Assessments", href: "/dashboard/assessments", icon: PenTool },
  { label: "Results", href: "/dashboard/results", icon: Award },
  ...
  { label: "Portfolio", href: "/dashboard/learner/portfolio", icon: Bookmark },
  { label: "Fieldwork", href: "/dashboard/learner/fieldwork", icon: GraduationCap },
