...
export function PrimarySchools() {
  const institutions = getInstitutionsByLevel("Primary")
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <p className="mt-2 text-muted-foreground">
            Browse primary schools and their programs. Select a school to explore classes and subjects.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <div className="mt-4 pt-1">
                  <Link
                    href={`/schools/primary/${institution.id}`}
                    className={cn(
