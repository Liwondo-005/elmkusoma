...
export const courseLevels: CourseLevel[] = [
  { name: "Nursery", slug: "nursery", description: "Kusoma, Kuandika na Kuhesabu — early literacy and numeracy through play.", icon: "baby", subjectCount: 9 },
  { name: "Primary", slug: "primary", description: "Standard I to VI — core subjects including Kiswahili, English, Hisabati, and Sayansi.", icon: "school", subjectCount: 44 },
...
export const curriculumSubjects: CurriculumSubject[] = [
  { id: "nursery-baby1-kusoma", name: "Kusoma", level: "Nursery", className: "Baby 1", category: "Core", description: "Introduction to reading skills through phonics, letter recognition, and early literacy activities.", enrolled: 320 },
  { id: "nursery-baby1-kuandika", name: "Kuandika", level: "Nursery", className: "Baby 1", category: "Core", description: "Early writing practice including letter tracing, stroke patterns, and basic pen control.", enrolled: 310 },
  { id: "nursery-baby1-kuhesabu", name: "Kuhesabu", level: "Nursery", className: "Baby 1", category: "Core", description: "Introduction to numbers, counting, and basic arithmetic through playful activities.", enrolled: 315 },
  { id: "nursery-baby2-kusoma", name: "Kusoma", level: "Nursery", className: "Baby 2", category: "Core", description: "Building reading fluency with simple words, sentences, and early comprehension.", enrolled: 295 },
  { id: "nursery-baby2-kuandika", name: "Kuandika", level: "Nursery", className: "Baby 2", category: "Core", description: "Writing simple words and short sentences with increasing independence.", enrolled: 290 },
  { id: "nursery-baby2-kuhesabu", name: "Kuhesabu", level: "Nursery", className: "Baby 2", category: "Core", description: "Counting to 20, number recognition, and simple addition and subtraction.", enrolled: 288 },
  { id: "nursery-baby3-kusoma", name: "Kusoma", level: "Nursery", className: "Baby 3", category: "Core", description: "Reading short stories, comprehension exercises, and vocabulary building.", enrolled: 280 },
  { id: "nursery-baby3-kuandika", name: "Kuandika", level: "Nursery", className: "Baby 3", category: "Core", description: "Writing paragraphs, creative writing, and proper sentence construction.", enrolled: 275 },
  { id: "nursery-baby3-kuhesabu", name: "Kuhesabu", level: "Nursery", className: "Baby 3", category: "Core", description: "Number operations, patterns, and introduction to shapes and measurements.", enrolled: 278 },

  { id: "primary-s1-kusoma", name: "Kusoma na Kuandika", level: "Primary", className: "Standard 1", category: "Core", description: "Reading and writing fundamentals in Kiswahili including phonics and early composition.", enrolled: 450 },
  { id: "primary-s1-hisabati", name: "Hisabati", level: "Primary", className: "Standard 1", category: "Core", description: "Basic mathematics: numbers, addition, subtraction, and simple shapes.", enrolled: 445 },
  { id: "primary-s1-mazingira", name: "Mazingira/Maarifa ya Msingi", level: "Primary", className: "Standard 1", category: "Core", description: "Exploring the environment, basic science concepts, and social awareness.", enrolled: 440 },
  { id: "primary-s1-kiingereza", name: "Kiingereza", level: "Primary", className: "Standard 1", category: "Core", description: "Introduction to English: alphabet, basic vocabulary, and simple greetings.", enrolled: 435 },
  { id: "primary-s1-dini", name: "Elimu ya Dini", level: "Primary", className: "Standard 1", category: "Core", description: "Religious education covering basic moral values and spiritual awareness.", enrolled: 430 },
  { id: "primary-s1-sanaa", name: "Sanaa na Michezo", level: "Primary", className: "Standard 1", category: "Core", description: "Arts, crafts, music, and physical activities for creative development.", enrolled: 425 },
  ...
  { id: "primary-s2-hisabati", name: "Hisabati", level: "Primary", className: "Standard 2", category: "Core", description: "Mathematics: multiplication basics, division concepts, and word problems.", enrolled: 435 },
  { id: "primary-s2-kiingereza", name: "Kiingereza", level: "Primary", className: "Standard 2", category: "Core", description: "English language basics: sentences, simple reading, and conversation.", enrolled: 430 },
  { id: "primary-s2-sayansi", name: "Sayansi/Maarifa ya Mazingira", level: "Primary", className: "Standard 2", category: "Core", description: "Science and environmental studies: living things, water, and weather.", enrolled: 425 },
  { id: "primary-s2-dini", name: "Elimu ya Dini", level: "Primary", className: "Standard 2", category: "Core", description: "Religious education with emphasis on community values and ethics.", enrolled: 420 },
  { id: "primary-s2-sanaa", name: "Sanaa na Michezo", level: "Primary", className: "Standard 2", category: "Core", description: "Creative arts, sports, and physical education activities.", enrolled: 418 },
  ...
  { id: "primary-s3-hisabati", name: "Hisabati", level: "Primary", className: "Standard 3", category: "Core", description: "Mathematics: fractions, decimals, measurement, and geometry introduction.", enrolled: 420 },
  { id: "primary-s3-sayansi", name: "Sayansi", level: "Primary", className: "Standard 3", category: "Core", description: "Science: human body, plants, animals, and basic experiments.", enrolled: 415 },
  { id: "primary-s3-historia", name: "Historia ya Tanzania na Maadili", level: "Primary", className: "Standard 3", category: "Core", description: "Tanzanian history, cultural heritage, and moral values.", enrolled: 410 },
  { id: "primary-s3-jiografia", name: "Jiografia na Mazingira", level: "Primary", className: "Standard 3", category: "Core", description: "Geography: maps, climate, natural resources, and environmental conservation.", enrolled: 408 },
  { id: "primary-s3-dini", name: "Elimu ya Dini", level: "Primary", className: "Standard 3", category: "Core", description: "Religious studies exploring faith, practice, and community responsibility.", enrolled: 405 },
  { id: "primary-s3-sanaa", name: "Sanaa na Michezo", level: "Primary", className: "Standard 3", category: "Core", description: "Visual arts, performing arts, and sports activities.", enrolled: 403 },
  ...
  { id: "primary-s4-hisabati", name: "Hisabati", level: "Primary", className: "Standard 4", category: "Core", description: "Mathematics: percentages, ratios, data handling, and problem solving.", enrolled: 415 },
  { id: "primary-s4-sayansi", name: "Sayansi", level: "Primary", className: "Standard 4", category: "Core", description: "Science: matter, energy, forces, and the solar system.", enrolled: 410 },
  { id: "primary-s4-historia", name: "Historia ya Tanzania na Maadili", level: "Primary", className: "Standard 4", category: "Core", description: "Tanzanian history: pre-colonial, colonial, and independence movements.", enrolled: 405 },
  { id: "primary-s4-jiografia", name: "Jiografia na Mazingira", level: "Primary", className: "Standard 4", category: "Core", description: "Geography: rivers, lakes, mountains, and economic activities.", enrolled: 403 },
  { id: "primary-s4-dini", name: "Elimu ya Dini", level: "Primary", className: "Standard 4", category: "Core", description: "Religious education: deeper understanding of faith and moral practice.", enrolled: 400 },
  { id: "primary-s4-sanaa", name: "Sanaa na Michezo", level: "Primary", className: "Standard 4", category: "Core", description: "Creative expression through art, music, dance, and athletics.", enrolled: 398 },
  ...
  { id: "primary-s5-hisabati", name: "Hisabati", level: "Primary", className: "Standard 5", category: "Core", description: "Mathematics: algebra basics, geometry, measurement, and statistics.", enrolled: 410 },
  { id: "primary-s5-sayansi", name: "Sayansi", level: "Primary", className: "Standard 5", category: "Core", description: "Science: ecosystems, simple machines, health, and nutrition.", enrolled: 405 },
  { id: "primary-s5-historia", name: "Historia ya Tanzania na Maadili", level: "Primary", className: "Standard 5", category: "Core", description: "Tanzanian history: governance, democracy, and national development.", enrolled: 400 },
  { id: "primary-s5-jiografia", name: "Jiografia na Mazingira", level: "Primary", className: "Standard 5", category: "Core", description: "Geography: population, urbanization, trade, and environmental issues.", enrolled: 398 },
  { id: "primary-s5-dini", name: "Elimu ya Dini", level: "Primary", className: "Standard 5", category: "Core", description: "Religious studies: ethics, social responsibility, and spiritual growth.", enrolled: 395 },
  { id: "primary-s5-sanaa", name: "Sanaa na Michezo", level: "Primary", className: "Standard 5", category: "Core", description: "Advanced arts, sports training, and creative projects.", enrolled: 393 },
  ...
  { id: "primary-s6-hisabati", name: "Hisabati", level: "Primary", className: "Standard 6", category: "Core", description: "Mathematics: advanced problem solving, geometry, and exam techniques.", enrolled: 405 },
  { id: "primary-s6-sayansi", name: "Sayansi", level: "Primary", className: "Standard 6", category: "Core", description: "Science: revision of key concepts, practical applications, and exam prep.", enrolled: 400 },
  { id: "primary-s6-historia", name: "Historia ya Tanzania na Maadili", level: "Primary", className: "Standard 6", category: "Core", description: "Tanzanian history: comprehensive review and national identity.", enrolled: 395 },
  { id: "primary-s6-jiografia", name: "Jiografia na Mazingira", level: "Primary", className: "Standard 6", category: "Core", description: "Geography: map skills, resource management, and global awareness.", enrolled: 393 },
  { id: "primary-s6-dini", name: "Elimu ya Dini", level: "Primary", className: "Standard 6", category: "Core", description: "Religious education: values review and spiritual preparation.", enrolled: 390 },
  { id: "primary-s6-sanaa", name: "Sanaa na Michezo", level: "Primary", className: "Standard 6", category: "Core", description: "Creative arts and sports: showcase projects and competitions.", enrolled: 388 },
  ...
  { id: "lower-f1-maadili", name: "Historia ya Tanzania na Maadili", level: "Lower Secondary", className: "Form I", category: "Core", description: "Tanzanian history and moral values: citizenship and ethics.", enrolled: 345 },
  ...
  { id: "lower-f2-maadili", name: "Historia ya Tanzania na Maadili", level: "Lower Secondary", className: "Form II", category: "Core", description: "Tanzanian governance, cultural heritage, and moral development.", enrolled: 340 },
  ...
  { id: "lower-f3-maadili", name: "Historia ya Tanzania na Maadili", level: "Lower Secondary", className: "Form III", category: "Core", description: "Political history of Tanzania, national values, and civic duty.", enrolled: 338 },
  ...
  { id: "lower-f4-maadili", name: "Historia ya Tanzania na Maadili", level: "Lower Secondary", className: "Form IV", category: "Core", description: "Tanzanian studies: comprehensive review and exam techniques.", enrolled: 333 },
  ...
  { id: "adv-fv-maadili", name: "Historia ya Tanzania na Maadili", level: "Advanced Secondary", className: "Form V", category: "Social Science", description: "Advanced Tanzanian history and moral philosophy.", enrolled: 160 },
  ...
  { id: "adv-fvi-maadili", name: "Historia ya Tanzania na Maadili", level: "Advanced Secondary", className: "Form VI", category: "Social Science", description: "Advanced Tanzanian studies and national exam preparation.", enrolled: 150 },
...
export const primaryClasses: PrimaryClass[] = [
  { id: "darasa-1", name: "Darasa I", label: "Standard 1", ages: "6-7 yrs", subjects: ["Kusoma na Kuandika", "Hisabati", "Mazingira na Maarifa ya Msingi", "Kiingereza", "Elimu ya Dini", "Sanaa na Michezo"] },
  { id: "darasa-2", name: "Darasa II", label: "Standard 2", ages: "7-8 yrs", subjects: ["Kiswahili", "Hisabati", "Kiingereza", "Sayansi na Maarifa ya Mazingira", "Elimu ya Dini", "Sanaa na Michezo"] },
  { id: "darasa-3", name: "Darasa III", label: "Standard 3", ages: "8-9 yrs", subjects: ["Kiswahili", "English", "Hisabati", "Sayansi", "Historia ya Tanzania na Maadili", "Jiografia na Mazingira", "Elimu ya Dini", "Sanaa na Michezo"] },
  { id: "darasa-4", name: "Darasa IV", label: "Standard 4", ages: "9-10 yrs", subjects: ["Kiswahili", "English", "Hisabati", "Sayansi", "Historia ya Tanzania na Maadili", "Jiografia na Mazingira", "Elimu ya Dini", "Sanaa na Michezo"] },
  { id: "darasa-5", name: "Darasa V", label: "Standard 5", ages: "10-11 yrs", subjects: ["Kiswahili", "English", "Hisabati", "Sayansi", "Historia ya Tanzania na Maadili", "Jiografia na Mazingira", "Elimu ya Dini", "Sanaa na Michezo"] },
  { id: "darasa-6", name: "Darasa VI", label: "Standard 6", ages: "11-12 yrs", subjects: ["Kiswahili", "English", "Hisabati", "Sayansi", "Historia ya Tanzania na Maadili", "Jiografia na Mazingira", "Elimu ya Dini", "Sanaa na Michezo"] },
]
...
export const studyMaterials: StudyMaterial[] = [
  ...
  { id: "mat-010", title: "Kiswahili Fasihi — Utunzi & Ushairi", subject: "Kiswahili", level: "Secondary", type: "notes", access: "view", instructor: "Mwalimu Rehema", pages: 20 },
